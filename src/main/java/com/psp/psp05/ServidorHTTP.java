...
class ServidorHTTP {
    ...
    public static void main(String[] args) throws IOException, Exception {
        ...
        while (true) {
            ...
            //Crear hilo
            ProcesarPeticiones hilo = new ProcesarPeticiones(socCliente);
            hilo.start();
        }
    }
    ...
    */
    public static void procesaPeticion(Socket socketCliente) throws IOException {
        ...
        //Descartamos peticion si es nula por error Clientes Rest envian
        //dos peticiones
        if (peticion != null) {
            crearPeticion(peticion, html, printWriter);
        }
    ...
    * @param printWriter 
    */
    private static void crearPeticion (String peticion, String html, PrintWriter printWriter) {
